...
BOA是一个小型的C开源软件。如果看了Advanced Programming in the UNIX Environment（APUE）和了解网络通信之后，再读源代码可能会更清晰一些。也可以看看其他的开源项目 [最值得学习阅读的10个C语言开源项目代码](http://www.csdn123.com/html/topnews201408/93/6593.htm)。
